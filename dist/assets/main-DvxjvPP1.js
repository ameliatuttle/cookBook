import"./style-DDU8vXqv.js";document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("stickyNotesContainer");(JSON.parse(localStorage.getItem("recipes"))||[]).forEach(t=>{const e=document.createElement("div");e.classList.add("sticky-note"),e.style.backgroundColor=t.type==="create"?"lightblue":"lightgreen",t.type==="create"?e.innerHTML=`
                <h3>${t.title||""}</h3>
